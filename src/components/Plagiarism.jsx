          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 bg-cyan-400 rounded flex items-center font-Raleway text-xl justify-center">
              ...
              <button className="bg-cyan-400 hover:bg-cyan-500 text-black font-semibold px-6 py-3 rounded-lg transition-colors duration-200 flex items-center space-x-2">
                <span>Try it</span>
            ...
            {/* Right Content - Downloaded Image */}
